  ...
  <div class="border border-gray-200 p-3 mb-4 rounded">
    ...
    <div v-show="showForm">
      ...
      <vee-form :validation-schema="schema" :initial-values="song" @submit="edit">
        ...
        :disabled="in_submission">Submit</button>
        <button type="button" class="py-1.5 px-3 rounded text-white bg-gray-600"
                :disabled="in_submission" @click.prevent="showForm=false">Go Back</button>
      </vee-form>
    </div>
  </div>
...
export default {
  ...
  methods:{
    // vee-validate is passing the data to the edit function
    async edit(values){
      this.in_submission = true;
      this.show_alert = true;
      this.alert_message = 'bg-blue-500';
